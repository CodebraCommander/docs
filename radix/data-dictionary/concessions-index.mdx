...
* **Analyze Floor Plan Concessions:**Concessions data can be viewed at the floor plan *and* unit level. Use the [Trends](kb://article/zendesk:radix:9060097289101) feature to explore concessions for different floor plans, or use the [Floor Plan Comparison Report](kb://article/zendesk:radix:15100961400845) for comprehensive details on what concessions are being offered for specific units.