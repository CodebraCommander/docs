...
![three dots.PNG](/images/radix/cc5f6278799ab90967dc6496fd4426b2abb8a845.png)Lastly, in the top-right corner, click [Managing Listings](kb://article/zendesk:radix:38097140623373) to manage your property’s information, edit photos and amenities, update concessions and fees and deposits or view integrations.
...
Below is the **Competitor Updates** table, which features three [colored clock icons](kb://article/zendesk:radix:38637617332365) to help you quickly identify when a survey needs updating. Under each clock icon, you’ll see the source of the data—whether it was web scraped, integrated, or user-generated. If you want to manually [update your competitors](kb://article/zendesk:radix:37874525132941) data, click *Update Property*.
