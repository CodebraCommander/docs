...
<Frame caption="Manage property listings and view competitor updates in RealRents.">
...
<Frame caption="Manage move-in costs for tenants in RealRents.">
...
<Frame caption="Button to add move-in costs in RealRents fees and deposits section.">
...
<Frame caption="Form to add move-in costs, including fee name, type, amount, and unit selection.">
...
<Frame caption="Popup for adding move-in costs with options to apply to specific units or all.">
...
<Frame caption="Manage tenant fees and deposits, including application fees and monthly charges.">
