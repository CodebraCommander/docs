---
description: "The Benchmark API returns data for your subject properties and the competitor properties youve selected for them within Benchmark In order to leverage this A..."
title: "Benchmark API Overview"
---

The Benchmark API returns data for your subject properties and the competitor properties you've selected for them within Benchmark. In order to leverage this API, you will need to create a unique token. You can follow the instructions on how to do so by reviewing our [Getting Your API Key](/radix/api/getting-your-api-key) resource.
...
For a complete list of definitions for all data responses, [click here.](kb://article/zendesk:radix:17703147105421)
