---
description: The Radix API is a powerful feature designed to enable the seamless integration
  of your Radix data into your existing business intelligence tools and platfor...
...
<Frame caption="Diagram illustrating the flow of requests and responses between an app, the internet, and Radix API.">
  <img src="/images/radix/942a821127d71916e08bbbdffe5d1a5db0ef5464.png" alt="Radix" />
</Frame>
...
| --- | --- |
| [Benchmark API](kb://article/zendesk:radix:16961346397837) | This API provides you with the available data from your subject properties and their comparable properties.  |
