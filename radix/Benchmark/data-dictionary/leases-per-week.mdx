---
description: In this article well define what Leases per Week is and offer actionable
  advice on how to make the most of this data in Radix
...
* **Low Leases per Week & High ATR:** When a property has units available to rent, but isn't securing leases, you'll be naturally inclined to wonder why. Use the [Snapshot](kb://article/zendesk:radix:9060091043981) and [Trends](kb://article/zendesk:radix:9060097289101) features to benchmark a property's performance with its competitors and investigate why.
