...
* **Analyzing Submarket Trends:** Your [Market Trends](../../research/market-trends.mdx) feature can be used to gain additional local context on traffic patterns at the submarket and market level. These trends are fueled by weekly data provided by every available Radix property within the MSA for the latest market insights.
