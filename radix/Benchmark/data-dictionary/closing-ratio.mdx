---
description: When you need to quantify a team or individuals ability to convert traffic
  to leases look no further than the closing ratio This article not only defines wha...
title: Closing Ratio
---
...
* **ATR:** How many units are available to rent over the next 60 days, and how does that compare to the availability of comparable properties? Use tools like your [Floor Plan Comparison Report](../report-overviews/floor-plan-comparison-report-overview.mdx) to view availability and concessions at the floor plan level.
...
* **Curb Appeal:** How does the property show to prospects? Is the property's appearance appealing, or a deterrent? Use your built-in [Reputation](kb://article/zendesk:radix:9060154685965) feature to help make sure the property is putting its best foot forward.
