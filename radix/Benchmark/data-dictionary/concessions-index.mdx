---
description: In this article well define what this data point is how its calculated
  and outline practical tips and tools you can use to evaluate your Concessions Index
  data
...
* **Analyze Floor Plan Concessions:**Concessions data can be viewed at the floor plan *and* unit level. Use the [Trends](kb://article/zendesk:radix:9060097289101) feature to explore concessions for different floor plans, or use the [Floor Plan Comparison Report](../report-overviews/floor-plan-comparison-report-overview.mdx) for comprehensive details on what concessions are being offered for specific units.