...
<Steps>
  <Step title="**Occupancy Percentage (%):** [Click here](occupancy-percentage) to see how we calculate this metric.">
  </Step>
  <Step title="**Leased Percentage (%):** [Click here](leased-percentage) to see how we calculate this metric.">
  </Step>
  <Step title="**Apartments to Rent (ATR):** A property's *60-day availability* is calculated. [Click here](apartments-to-rent-atr) to see how we calculate this metric.">
  </Step>
  <Step title="**Rents:** To maintain consistency in our platform, a property's rents are displayed by unit type and reflect pricing for 12-month lease terms. [Click here](rent) to see how rents are calculated.">
  </Step>
  <Step title="**Traffic per Week:** [Click here](traffic-per-week) to see how we calculate this metric.">
  </Step>
  <Step title="**Leases per Week:** A property's *net leases* are calculated. [Click here](leases-per-week) to see how.">
  </Step>
</Steps>
