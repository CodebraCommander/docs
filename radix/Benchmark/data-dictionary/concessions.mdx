...
**Note:** Our Concessions Calculator is a built-in tool that helps calculate the value of concessions for users entering them. Learn more about it [here.](../../legacy/adding-concessions-legacy)  
...
* **Conduct a Trends Analysis:** Our [Trends Analysis Report](../report-overviews/trend-analysis-report-overview) allows you to stack data trends for key metrics like ATR, Traffic and Leases per Week, and Closing Ratio. It's a great tool to help analyze whether concessions offered are contributing to a property's ability to drive traffic, secure leases, and mitigate ATR.
* **Analyze Floor Plan Concessions:**Concessions data can be viewed at the floor plan *and* unit level. Use the [Trends](kb://article/zendesk:radix:9060097289101) feature to explore concessions for specific floor plans, or use the [Floor Plan Comparison Report](../report-overviews/floor-plan-comparison-report-overview) for comprehensive details on what concessions are being offered for specific units.
