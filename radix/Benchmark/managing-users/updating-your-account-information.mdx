...
<Frame caption="User account management interface with options for updating details and changing password.">
...
<Frame caption="User account management interface with options to update details and change password.">
...
<Frame caption="Change password and settings for renewal percentage and timezone selection.">
