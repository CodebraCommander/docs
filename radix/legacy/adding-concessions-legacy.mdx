...
*If your organization is using this new version, please check the [Concessions](../realrents/fees-deposits-and-concessions/how-to-update-concessions-in-realrents.mdx)* *article in the **RealRents Help Center**for updated instructions and guidance.* |
...
<Frame caption="Add and manage concessions for each floor plan in the property survey.">
...
<Frame caption="Apply bulk concessions to multiple floor plans in the property management tool.">
...
<Frame caption="Form for adding concessions to floor plans, including options for duration and lease length.">
