...
description: Streamline the market survey process for your teams even more with our
  ...
  data...
sidebarTitle: "OneSite Integration Setup"
...
<Frame caption="Integration Marketplace with Vendor Listing and search functionality.">
...
<Frame caption="Integration management interface for enabling or disabling various integrations.">
