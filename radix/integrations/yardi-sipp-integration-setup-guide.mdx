---
description: Streamline the market survey process for your teams further with our
  Yardi SIPP integration When you leverage our Yardi SIPP integration the majority
  of the ...
sidebarTitle: "Yardi SIPP Integration Setup"
...
<Frame caption="Interface configuration settings for reviewing interface vendors in Yardi Voyager.">
  <img src="/images/radix/e9693f9b921e469953a50bd182bb25330eb708c8.png" alt="Review Interface Vendors.png" />
</Frame>
...
<Frame caption="Interface configuration settings for entity type and display rows in Yardi SIPP.">
  <img src="/images/radix/c7436d07718bcb470477be7d6c2f3e99aab99f51.png" alt="Common Data Interface.png" />
</Frame>
...
<Frame caption="Common Data Configuration settings for Radix - ILS, including permissions and attachment types.">
  <img src="/images/radix/c2ca4259e81563b45b31072e1c7259b579c945ec.png" alt="Lease Charges Permission.png" />
</Frame>
...
* Go to Interfaces -> Interface Configuration -> ILS/Guest Card -> find Radix - ILS. The 'Include only Residents/Guests with activity in the last' field must be set to 90 days.


<Frame caption="ILS & Guest Card Configuration settings for resident/guest activity options.">
  <img src="/images/radix/ab04621bbfe2df2a533fdfcc865ae518c2102232.png" alt="thumbnail_Outlook-o1mbxis4.png" />
</Frame>
