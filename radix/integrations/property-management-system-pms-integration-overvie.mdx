...
<Steps>
  <Step title="**Occupancy Percentage (%):** [Click here](../Benchmark/data-dictionary/occupancy-percentage.mdx) to learn how we calculate this metric.">
  </Step>
  <Step title="**Leased Percentage (%):** [Click here](../Benchmark/data-dictionary/leased-percentage.mdx) to learn how we calculate this metric.">
  </Step>
  <Step title="**Apartments to Rent (ATR):** A property's *60-day* availability is calculated. [Click here](../Benchmark/data-dictionary/apartments-to-rent-atr.mdx) to learn how we calculate this metric.">
  </Step>
  <Step title="**Rents:** To maintain consistency in our platform, a property's rents are displayed by unit type and reflect pricing for 12-month lease terms. [Learn more here](../Benchmark/data-dictionary/rent.mdx).">
  </Step>
  <Step title="**Traffic per Week:** [Click here](../Benchmark/data-dictionary/traffic-per-week.mdx) to learn how we calculate this metric.">
  </Step>
  <Step title="**Leases per Week:** [Click here](../Benchmark/data-dictionary/leases-per-week.mdx) to learn how we calculate this metric.">
  </Step>
</Steps>
