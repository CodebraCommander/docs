...
<Steps>
  <Step title="**Occupancy Percentage (%):** [Click here](kb://article/zendesk:radix:19747721543565) to learn how we calculate this metric.">
  </Step>
  <Step title="**Leased Percentage (%):** [Click here](kb://article/zendesk:radix:19989650203149) to learn how we calculate this metric.">
  </Step>
  <Step title="**Apartments to Rent (ATR):** A property's *60-day* availability is calculated. [Click here](kb://article/zendesk:radix:20039849870349) to learn how we calculate this metric.">
  </Step>
  <Step title="**Rents:** To maintain consistency in our platform, a property's rents are displayed by unit type and reflect pricing for 12-month lease terms. [Learn more here](kb://article/zendesk:radix:20044063920397).">
  </Step>
  <Step title="**Traffic per Week:** [Click here](kb://article/zendesk:radix:19998806997133) to learn how we calculate this metric.">
  </Step>
  <Step title="**Leases per Week:** [Click here](kb://article/zendesk:radix:20042408340493) to learn how we calculate this metric.">
  </Step>
</Steps>
