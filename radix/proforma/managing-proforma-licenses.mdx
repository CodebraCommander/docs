...
<Frame caption="Dashboard for managing property analytics with options for user management and property updates.">
...
<Frame caption="User management interface displaying user details and options to add users, adjust columns, and apply filters.">
...
<Frame caption="User management interface for editing ProForma licenses.">
...
<Frame caption="User permissions management interface for Radix Research and ProForma licenses.">
...
<Frame caption="User permissions settings for Radix Research and Radix ProForma licenses.">
...
<Frame caption="ProForma license usage status with warning about reaching the limit.">
