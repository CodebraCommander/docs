...
<Frame caption="Dashboard displaying construction pipeline projects in Atlanta with a map and project details.">
...
<Frame caption="Dashboard displaying construction projects in Atlanta, with filters for stages and search options.">
...
<Frame caption="Interactive map displaying construction projects in Chicago with a search bar and project list.">
...
Our Construction Pipeline Report is highly customizable and allows you to interact with the data found on this dashboard in additional ways. You can bring yourself up to speed on the report and it's capabilities [here.](../Benchmark/report-overviews/construction-pipeline-report-overview.mdx)