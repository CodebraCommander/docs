...
<Frame caption="Dropdown menu for selecting submarkets in Austin, TX research section.">
...
<Frame caption="Line graph displaying market trends for various metrics over time, with a dropdown for floor plan options.">
...
<Frame caption="Portfolio snapshot showing property metrics and comparison options by location.">
...
<Frame caption="Line graph displaying trends in NER/SQFT for properties, comps, and California over time.">
...
<Frame caption="Line graph displaying traffic trends for Augustus Apartments and comparison with other locations over time.">
