...
**Digging Deeper:** Is your submarket or market saturated with new developments? Use the [Construction Pipeline Report](../Benchmark/report-overviews/construction-pipeline-report-overview) to summarize what phase of the construction lifecycle all projects in the market or submarket are in. 
...
**Instructions:** Use the [Share of Wallet](housing-affordability-dashboard) widget on the Housing Affordability dashboard to see what percentage of a renter's monthly income is typically spent on rent. You can explore this data point for any available market, any any span of time. 
