---
description: An API key will be necessary to unlock the API your organization has
  purchased This API key will be utilized by your organization to generate the token
  used ...
...
* Select *Data API* from the main dropdown menu![API](/images/radix/2c52e795568059293c9920a4861bc18e48e66e24.png)


* A new window will appear - from this window, you can view and/or generate an API key. ![Data](/images/radix/5631c886584f0eb94f7c0308020737942576bce9.png)
