---
description: The Benchmark API returns data for your subject properties and the competitor
  properties youve selected for them within Benchmark In order to leverage this A...
title: Benchmark API Overview
---

The Benchmark API returns data for your subject properties and the competitor properties you've selected for them within Benchmark. In order to leverage this API, you will need to create a unique token. You can follow the instructions on how to do so by reviewing our [Getting Your API Key](kb://article/zendesk:radix:17014663521037) resource. 
