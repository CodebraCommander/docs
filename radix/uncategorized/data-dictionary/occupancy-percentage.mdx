---
description: In the multifamily real estate realm occupancy is a fundamental metric
  for all invested in the success of a property to monitor This article not only defines...
