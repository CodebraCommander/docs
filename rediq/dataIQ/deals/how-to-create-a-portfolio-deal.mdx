...
**Rent Roll Example - ([Link to Rent Roll Up process](../rent-rolls/rent-roll-up.mdx))**
...
**Historicals Example - ([Link to Operating Statement Analysis process](../operating-statements/operating-statement-aggregate-analysis.mdx))**
...
* [Rent Roll Up](../rent-rolls/rent-roll-up.mdx)
* [Operating Statement Aggregate Analysis](../operating-statements/operating-statement-aggregate-analysis.mdx)