...
<Frame caption="Operating statement menu with options like Summary, Cash Flows, and Source Data.">
...
<Frame caption="Dropdown menu for uploading various financial documents, including Proforma options.">
...
<Frame caption="Upload interface for processing operating statements with drag-and-drop functionality.">
...
<Frame caption="Select &quot;Cash Flows&quot; under &quot;Operating Statement&quot; and choose report type.">
...
<Frame caption="Dropdown menu for selecting between Actuals and Proforma options in Operating Statement.">
...
<Frame caption="Dropdown menu for selecting report types, including &quot;Proforma vs Actual Report.&quot;">
...
<Frame caption="Dropdown menu for selecting chart of accounts in operating statements.">
...
<Frame caption="Export report options for Proforma vs Actual analysis in Excel format.">
...
<Frame caption="Enable editing in Protected View for secure document access.">
...
<Frame caption="Table displaying monthly actuals and proforma comparisons for various categories.">
...
<Frame caption="Dropdown menu for selecting report types in a cash flow comparison table.">
...
<Frame caption="Monthly cash flow comparison table with actual vs. budgeted figures and variance analysis.">
