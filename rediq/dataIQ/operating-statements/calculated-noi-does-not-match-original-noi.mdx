---
description: When mapping the Operating Statement data on the Source Data page the
  Calculated NOI and Original NOI appear at the bottom of the screen After the entire
  sta...
sidebarTitle: "Calculated NOI does not..."
...
<Frame caption="Context menu options for marking rows in an operating statement.">
  <img src="/images/rediq/39d90c9fb62e033d362935e8a3d82e5d10b17154.png" alt="NOIs not matching.PNG" />
</Frame>
