---
description: Configuring the Operating Statement reports will be similar to configuring
  the rent roll reports Some of the popular report exports frequently directly copie...
