...
To produce a rolled-up cash flow, use the Map Operating Statements feature by assigning the line items of an operating statement to the Chart of Accounts. Refer to the [**Chart of Accounts**](kb://article/zendesk:rediq:360036506651)page on how to customize line items. 
