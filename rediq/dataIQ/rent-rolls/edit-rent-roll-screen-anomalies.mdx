...
If the Market Rent or Net SF needs to be edited by floor please refer to the article detailing that process [here](edit-market-rent-or-square-footage-by-floor-plan).
