---
description: When multiple rent rolls have been uploaded in the same deal two more
  options will appear when hovering over the Rent Roll tab a Comparison Chart and
  Compari...
sidebarTitle: "Comparison Expired Lease..."
...
<Frame caption="Dropdown menu for Rent Roll section with options including Comparison Table and Rent Roll management.">
  <img src="/images/rediq/a1a28851d09da81a83d5c0ebc8bfffc5215b52d9.png" alt="Xyhs1lXQ3bdHw88GwyioKZ7ljOiIcVKjYg.png" />
</Frame>
