...
<Frame caption="Mappings dropdown menu in SmartMap+ interface.">
...
<Frame caption="Dropdown menu for mapping options, including SmartMap+ and applying mappings from another batch.">
...
<Frame caption="Batch selection interface for copying mappings in SmartMap+.">
...
<Frame caption="Dropdown menu for mapping options, including &quot;Apply Legacy Mappings.&quot;">
...
<Frame caption="Legacy mappings interface showing item assignments and mapping options for &quot;Happy Hollows.&quot;">
...
<Frame caption="Legacy Mappings interface with options to apply SmartMap+ and cancel actions.">
