---
description: valuationIQ and Excels Architecture
sidebarTitle: "Considerations for..."
...
<Steps>
  <Step title="Load your model in Excel">
  </Step>
  <Step title="Click "Sync with Cloud" to make sure your most recent assumptions are preserved.">
  </Step>
  <Step title="Log into dataIQ and navigate to the deal">
  </Step>
  <Step title="Click Generate Model and download a new copy to save locally">
  </Step>
</Steps>
...
<Steps>
  <Step title="Open the model in Excel">
  </Step>
  <Step title="Note the values in the Sensitivity Tables output tab">
  </Step>
  <Step title="Change assumption inputs that will affect sensitivity, and click Update Sensitives.">
  </Step>
  <Step title="Verify that the output values change">
  </Step>
</Steps>
