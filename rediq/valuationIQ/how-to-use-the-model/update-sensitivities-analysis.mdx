...
<Frame caption="Excel interface displaying the Investment Summary and options for updating sensitivity analysis.">
...
<Frame caption="Popup prompt asking to update sensitivity tables in redIQ model.">
