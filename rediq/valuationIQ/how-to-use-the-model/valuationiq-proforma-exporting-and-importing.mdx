...
<Frame caption="Table displaying deals with details like name, ID, status, market, and units.">
...
<Frame caption="Generate model and upload options for Northampton Apartment Homes overview.">
...
<Frame caption="Proforma export options and input fields for financial modeling in valuationIQ.">
  <img src="/images/rediq/5d0fa4d596ae87cd584dbec7da60e7e02eedc92f.png" alt="AA3.png" />
</Frame>


<Frame caption="ProForma Export tab in valuationIQ for exporting financial data.">
...
<Frame caption="Table displaying financial metrics with options to link to the model and export ProForma data.">
...
<Frame caption="Table displaying ProForma financial data with an &quot;Export ProForma&quot; header highlighted.">
...
[Proforma vs Actual User Guide FAQ](../../dataIQ/operating-statements/proforma-vs-actual-user-guide-faqs-beta.mdx)