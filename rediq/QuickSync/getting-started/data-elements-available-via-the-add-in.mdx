---
description: '| Group | Name | Named Range | DownloadUploadBoth | Description |

  |  |  |  |  |  |

  | Property Details | Deal Name | rediq\dealname |  |  |

  | Property Details...'
sidebarTitle: "Data Elements Available..."
...
| Operating Statement Data | Cash Flow Overview (redIQ Standard) | rediq\_cashflow\_overview\_standard |  |  |
| Operating Statement Data | Cash Flow All Months Proforma 1 | 

rediq\_cashflow\_allmonths\_Proforma\_1




 |  |  |
| Operating Statement Data | Line Items All Months Proforma 1 | 

rediq\_lineitems\_allmonths\_Proforma\_1
