...
<Frame caption="Excel ribbon showing the rediQ Add-in option highlighted.">
...
<Frame caption="redIQ Add-in login interface with fields for username and password.">
...
<Frame caption="redIQ Add-in interface showing unconfigured destinations for 2-way sync setup.">
...
<Frame caption="Spreadsheet showing return metrics for Quicksync 2-Way Sync options.">
...
<Frame caption="redIQ Add-in interface for selecting data elements to sync.">
