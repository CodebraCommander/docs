---
description: This guide will explain how to use the redIQ QuickSync Excel Addin to
  populate an Excel model template The goal is to configure your template so data
  can be ...
