---
description: "Excel on Windows Version  Build  or later connected to Office  RECOMMENDED\n\
  \t Note for best performance use the latest version of Excel  on Windows\n\t Note\
  \ you..."
title: Compatibility
---
