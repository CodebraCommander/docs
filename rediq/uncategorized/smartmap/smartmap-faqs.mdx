---
description: SmartMap is an automated tool designed to streamline the process of mapping
  lineitem accounts from an Operating Statement to your Chart of Accounts It uses
  a...
title: SmartMap+ FAQs
---
